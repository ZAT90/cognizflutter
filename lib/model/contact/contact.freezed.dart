...
abstract class $ContactModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? success, Status? status, List<Data>? data});
...
class _$_ContactModel implements _ContactModel {
  const _$_ContactModel({this.success, this.status, final List<Data>? data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'ContactModel(success: $success, status: $status, data: $data)';
  }
...
abstract class _ContactModel implements ContactModel {
  const factory _ContactModel(
      {final bool? success,
      final Status? status,
      final List<Data>? data}) = _$_ContactModel;
...
class _$_Status implements _Status {
  const _$_Status({this.code, this.message});
...
abstract class _Status implements Status {
  const factory _Status({final String? code, final String? message}) =
      _$_Status;
...
class _$_Data implements _Data {
  const _$_Data({this.id, this.name, this.email});
...
abstract class _Data implements Data {
  const factory _Data(
      {final String? id, final String? name, final String? email}) = _$_Data;
